...
<body>
	...
	<!----   CONTENT    ---->
	<div id="textWrapper">
		<h2>Αλλαγή κωδικού πρόσβασης</h2><br/><br/>

		<form class="table-form" action="includes/change_pass.php" method="POST">
			<table>
				<tr>
					<td><h3>Παλιός κωδικός:</h3></td>
					<td><input type="password" pattern="^[0-9a-zA-Z]+$" maxlength="20" name="old_pass" required="required" autocomplete="off"/></td>
				</tr>
				<tr>
					<td><h3>Νέος κωδικός:</h3></td>
					<td><input type="password" pattern="^[0-9a-zA-Z]+$" maxlength="20" name="new_pass" required="required" autocomplete="off"/></td>
				</tr>
				<tr>
					<td><h3>Επαλήθευση:</h3></td>
					<td><input type="password" pattern="^[0-9a-zA-Z]+$" maxlength="20" name="new_pass2" required="required" autocomplete="off"/></td>
				</tr>
				<?php
					$tmp = $_SESSION['username'];
					echo "<tr>
								<td><br/><br/><button type='submit' name='change_bt' value=".$tmp.">Αποθήκευση κωδικού</button></td>
						  	</tr>";
				?>
			</table>
		</form>
