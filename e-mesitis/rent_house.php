...
<html>
<head>
	<title>Ενοικιάσεις κατοικιών</title>
	<meta charset="utf-8"/>
...
<body>
	...
	<!----   CONTENT    ---->
  <div id="textWrapper">
    <h1>Κατοικίες προς ενοικίαση</h1>
		<br/><br/><br/>

    	<?php
    		$query = "SELECT * FROM ads WHERE type='Rent' AND category='Property' ORDER BY ad_id DESC LIMIT 6";
