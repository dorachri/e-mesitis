...
<body>
	...
	<!----   CONTENT    ---->
	<div id="textWrapper">
		<h2>Όραμά μας...</h2><br/><br/>
	  <p>
			Η ανεύρεση ακινήτου κάθε είδους είναι μια ιδιαίτερη διαδικασία με πολλούς αντικειμενικούς και υποκειμενικούς παράγοντες, συχνά με έλλειψη διαφάνειας και πολλές παγίδες.
	    Όραμα όλων εμάς στο e-mesitis είναι να διευκολύνουμε αυτή τη διαδικασία και να αλλάξουμε τον τρόπο που πραγματοποιείται η αναζήτηση ακινήτου στη χώρα μας.<br/><br/>
	    Καλή αναζήτηση!
	  </p>
  </div>
