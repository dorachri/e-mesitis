...
<html>
<head>
	<title>Πωλήσεις επαγ. χώρων</title>
	<meta charset="utf-8"/>
...
<body>
	...
	<div id="menuWrapper">
	    ...
	    <li><a class="active" href="">Πωλήσεις</a>
				<ul class="submenu">
	...
	<!----   CONTENT    ---->
  <div id="textWrapper">
    <h1>Επαγ. Χώροι προς πώληση</h1>
		<br/><br/><br/>

    	<?php
    		$query = "SELECT * FROM ads WHERE type='Sale' AND category='Business Property' ORDER BY ad_id DESC LIMIT 6";
